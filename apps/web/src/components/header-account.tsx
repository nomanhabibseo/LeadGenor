  ...
  return (
    <div className="flex shrink-0 items-center gap-2">
      <button
        type="button"
        onClick={toggle}
        className="rounded-lg border border-white/20 bg-white/10 p-2 text-slate-100 transition hover:bg-white/15"
      ...
      <div className="relative">
        ...
        {open && (
          <>
            ...
            <div className="absolute right-0 top-full z-50 mt-2 w-[min(100vw-2rem,20rem)] rounded-xl border border-slate-200 bg-white p-4 text-sm shadow-xl dark:border-slate-600 dark:bg-slate-900">
